...
public class AlexDAO implements DAO {
    ...
    public void upsert(@NotNull final ByteBuffer key, @NotNull final ByteBuffer value) throws IOException {
        ...
        currentHeap += Integer.BYTES
                + (long) (key.remaining() + LINK_SIZE + Integer.BYTES * NUMBER_FIELDS_BYTE_BUFFER)
                + (long) (value.remaining() + LINK_SIZE + Integer.BYTES * NUMBER_FIELDS_BYTE_BUFFER)
                + Integer.BYTES;
        checkHeap();
    }
    ...
    public void remove(@NotNull final ByteBuffer key) throws IOException {
        ...
        if (removedRow == null) {
            currentHeap += Integer.BYTES
                    + (long) (key.remaining() + LINK_SIZE + Integer.BYTES * NUMBER_FIELDS_BYTE_BUFFER)
                    + (long) (LINK_SIZE + Integer.BYTES * NUMBER_FIELDS_BYTE_BUFFER)
                    + Integer.BYTES;
